...
')
     ...
     */ 
         ...
         * @access public
         * @param string $ext
         * @return \App\Services\Image\obj 
         * @static 
         */ 
        public static function setExtention($ext)
        {
                        /** @var \App\Services\Image\Image $instance */
                        return $instance->setExtention($ext);
        }
                    /**
         * Set height
         *
         ...
         * @static 
         */ 
        public static function get($path, $object, $width = null)
        {
                        /** @var \App\Services\Image\Image $instance */
                        return $instance->get($path, $object, $width);
        }
                    /**
         ...
         * @static 
         */ 
        public static function thumbs($imageForm, $object)
        {
                        /** @var \App\Services\Image\Image $instance */
                        $instance->thumbs($imageForm, $object);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function deleteImage($item, $object)
        {
                        /** @var \App\Services\Image\Image $instance */
                        return $instance->deleteImage($item, $object);
        }
...
namespace  { 
            ...
            class ImageThumb extends \App\Services\Image\ImageFacade {}
            class CurrentUser extends \App\Services\CurrentUser {}
